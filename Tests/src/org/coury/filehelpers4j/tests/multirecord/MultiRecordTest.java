 ...
 */
package org.coury.filehelpers4j.tests.multirecord;
...
import org.coury.filehelpers4j.multirecord.MultiRecordEngine;
import org.coury.filehelpers4j.tests.types.customers.CustomersVerticalBarVirgula;
...
import org.coury.filehelpers4j.tests.types.orders.OrdersVerticalBar;
...
public class MultiRecordTest extends TestCase {
	...
	public void testMultiRecordRead() throws IOException {
		...
		List<Object> mult = engine.readFile(System.getProperty("user.dir") + "/Resources/test/Good/Multirecord-example.txt");
