 ...
 */
package org.coury.filehelpers4j.tests.masterdetailmultirecord;
...
import org.coury.filehelpers4j.masterdetail.RecordAction;
import org.coury.filehelpers4j.masterdetail.RecordActionSelector;
import org.coury.filehelpers4j.masterdetailmultirecord.MasterDetailMultiRecordEngine;
import org.coury.filehelpers4j.masterdetailmultirecord.MasterDetailMultiRecordFluentImplement;
import org.coury.filehelpers4j.tests.types.multirecord.Fonograma;
import org.coury.filehelpers4j.tests.types.multirecord.HeaderFonograma;
import org.coury.filehelpers4j.tests.types.multirecord.HeaderObra;
import org.coury.filehelpers4j.tests.types.multirecord.HeaderTitular;
import org.coury.filehelpers4j.tests.types.multirecord.InstrumentosFonograma;
import org.coury.filehelpers4j.tests.types.multirecord.LocalizacaoEDocumentacaoHelper;
import org.coury.filehelpers4j.tests.types.multirecord.ObraMusicalHelper;
import org.coury.filehelpers4j.tests.types.multirecord.PseudonimoHelper;
import org.coury.filehelpers4j.tests.types.multirecord.SubTitulo;
import org.coury.filehelpers4j.tests.types.multirecord.TitularHelper;
import org.coury.filehelpers4j.tests.types.multirecord.TitularesFonograma;
import org.coury.filehelpers4j.tests.types.multirecord.TitularesObra;
import org.coury.filehelpers4j.tests.types.multirecord.TraillerFonograma;
import org.coury.filehelpers4j.tests.types.multirecord.TraillerObra;
import org.coury.filehelpers4j.tests.types.multirecord.TraillerTitular;
...
public class MasterDetailMultiRecordTest extends TestCase {
	...
	private static final String FILE_NAME = System.getProperty("user.dir") + "/Resources/test/Good/masterdetailmultirecord-result.txt";
	...
	public void testLeituraArquivoDeLayout() throws Exception {
		result = engine.readFile(System.getProperty("user.dir") + "/Resources/test/Good/masterdetailmultirecord-example.txt");
	...
	public void testEscritaArquivoDeLayout() {
		try {
			result = engine.readFile(System.getProperty("user.dir") + "/Resources/test/Good/masterdetailmultirecord-example.txt");
			engine.writeFile(FILE_NAME, result, 1);
