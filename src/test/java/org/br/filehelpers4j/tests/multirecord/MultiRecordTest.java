 ...
 */
package org.br.filehelpers4j.tests.multirecord;
...
import org.br.filehelpers4j.multirecord.MultiRecordEngine;
import org.br.filehelpers4j.tests.types.customers.CustomersVerticalBarVirgula;
...
import org.br.filehelpers4j.tests.types.orders.OrdersVerticalBar;
...
public class MultiRecordTest extends TestCase {
	...
	public void testMultiRecordRead() throws IOException {
		...
		List<Object> mult = engine.readFile(getClass().getResource("/test/Good/Multirecord-example.txt").getPath());
		...
		engine.writeFile(getClass().getResource("/test/Good/Multirecord-example.txt").getPath(), list, 0);
